...
export function FloatingOptionsPanel({ onClose }: Props) {
    ...
    const getStyles = (): React.CSSProperties => {
        ...
        if (mode === 'COLLAPSED') return { ...base, bottom: 20, right: 500, width: '220px', height: '40px', borderRadius: '8px', transform: 'none' };
        ...
        <div ref={elementRef as any} style={getStyles()}>
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span style={{ fontSize: '11px', fontWeight: 800, color: '#ffeb3b', letterSpacing: '1px' }}>◈ OPTIONS · GEX</span>
                </div>
            ...
            {mode === 'COLLAPSED' && (
                <div style={{ height: '100%', display: 'flex', alignItems: 'center', padding: '0 12px', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '10px', color: '#ffeb3b' }}>◈ OPTIONS · GEX</span>
